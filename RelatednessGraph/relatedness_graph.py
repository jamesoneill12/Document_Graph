...
def doc_ents(filename, f):
    ...
    ner = StanfordNERTagger('C:/Users/1/James/stanford-ner-2015-12-09/classifiers/english.all.3class.distsim.crf.ser.gz',
...
if __name__ == '__main__':
    ...
    results = Parallel(n_jobs=num_cores)(delayed(doc_ents)(fname,f) for (fname,f) in zip(filenames,filepaths))
    relations = Parallel(n_jobs=num_cores)(delayed(doc_rel)(fname,f) for (fname,f) in zip(filenames,filepaths))
    print relations
